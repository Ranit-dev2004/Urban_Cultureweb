  ...
  return (
    <div className='flex flex-col lg:flex-row items-center justify-between px-6 lg:px-8 py-4 lg:py-8 bg-[#FFFFFF] h-[400px] lg:h-[550px]'>
      <div className='lg:w-1/2 w-full text-center lg:text-left'>
        ...
        <button className="mt-8 ml-20 bg-black text-white px-6 lg:px-8 py-2 lg:py-3 rounded-full text-sm lg:text-lg transform transition-transform hover:scale-105 duration-300">
          Shop Now
        </button>
      </div>
